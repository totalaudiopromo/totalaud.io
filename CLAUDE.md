...
- **Label OS is PARKED** behind `NEXT_PUBLIC_ENABLE_LABEL_OS` (default off). Code stays compiling; pre-park state at commit `68c2cf4`. Revival criteria in STRATEGY_2026 §8. Do not delete label code.
