...
describe('MeshOS Insight Summariser', () => {
  describe('generateDailySummary', () => {
    ...
    it('should have valid plan structure', async () => {
      ...
      const allPlans = [...summary.plans.last7d, ...summary.plans.last30d, ...summary.plans.last90d]
  ...
  describe('getTopOpportunities', () => {
    ...
    it('should return opportunities ordered by impact', () => {
      ...
      for (let i = 1; i < top.length; i++) {
        expect(impactWeight[top[i - 1].impact]).toBeGreaterThanOrEqual(impactWeight[top[i].impact])
      }
    })
