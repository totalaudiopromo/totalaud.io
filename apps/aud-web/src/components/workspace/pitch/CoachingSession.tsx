        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            <button
              ...
              className="md:hidden -ml-1 flex items-center justify-center w-9 h-9 rounded-lg text-ta-grey hover:text-white active:bg-white/5 transition-colors"
            >
              <svg
                width="18"
                height="18"
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="px-2 py-2 text-[11px] text-ta-grey hover:text-white transition-colors"
            >
              Clear
            </button>
            <button
      ...
      <div className="p-4 border-t border-white/5">
        <div className="flex gap-2">
          <textarea
            ...
            disabled={isLoading}
            rows={2}
            className="flex-1 px-3 py-2 text-base md:text-sm text-ta-white bg-[#161A1D] border border-white/10 rounded-lg resize-none outline-none focus:border-ta-cyan/30 focus:ring-1 focus:ring-ta-cyan/20 placeholder:text-ta-grey/50 disabled:opacity-50"
          />
          <button
            onClick={handleSend}
