...
const GALLERY_ITEMS = [
  {
    ...
    label: 'The Dream',
    year: '1988',
    description: 'A lifelong obsession with sound began here.',
  },
  {
    ...
    label: 'The Hustle',
    year: '2012',
    description: 'Gold Soundz — building a business out of a passion for music.',
  },
  {
    ...
    label: 'The Scene',
    year: '2015',
    description: 'Cutting teeth in the UK hardcore circuit with His & Hers.',
  },
  {
    ...
    label: 'The Catalyst',
    year: '2021',
    description: '5 years of radio promotion — identifying the gap for better tools.',
  },
  {
    ...
    label: 'Studio',
    year: '2023',
    description: 'Exploring sound design and production as sadact.',
  ...
  },
  {
    ...
    label: 'Radio',
    year: '2024',
    description: 'Behind the desk at Decadance UK.',
  },
  {
    ...
    label: 'The System',
    year: 'Present',
    description: 'Totalaud.io — built from years of experience, for the path ahead.',
  },
]
