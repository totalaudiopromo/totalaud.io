    ...
    <Card className="bg-[#161A1D] border border-white/5">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-lg font-medium text-tap-white tracking-tight">Campaign Trajectory</h3>
        </div>
        <div className="flex items-center gap-4 text-xs font-mono">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-tap-cyan shadow-[0_0_8px_rgba(58,169,190,0.5)]" />
            <span className="text-tap-grey">Coverage</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
            <span className="text-tap-grey">Replies</span>
          </div>
        </div>
      </div>
      ...
      {data.length === 0 ? (
        <div className="h-[300px] flex items-center justify-center border border-dashed border-white/5 rounded-2xl bg-white/[0.02]">
          <p className="text-sm text-tap-grey">Not enough data to project trajectory yet.</p>
        </div>
      ) : (
                  ...
                  if (active && payload && payload.length) {
                    return (
                      <div className="bg-[#161A1D]/90 backdrop-blur-md border border-white/10 p-3 rounded-lg shadow-xl">
                        <p className="text-xs font-mono text-tap-grey mb-2 uppercase">
                          Day {label}
                        </p>
                        <div className="space-y-1">
                          <p className="text-sm font-medium text-tap-white flex items-center justify-between gap-4">
                            <span className="text-tap-cyan">Coverage</span>
