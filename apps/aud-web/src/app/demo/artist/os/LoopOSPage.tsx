      ...
      >
        <div className="w-full h-full p-6">
          ...
          <div className="flex items-centre justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold">Creative Timeline</h1>
              <p className="text-sm text-foreground/60">Lana Glass — Midnight Signals EP</p>
            </div>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="bg-accent/5 border border-accent/20 rounded-lg p-4">
              ...
              <div className="relative h-12 bg-background/50 rounded overflow-hidden">
                {/* Timeline blocks */}
                <div className="absolute left-[10%] top-2 bottom-2 w-[20%] bg-accent/60 rounded" />
                <div className="absolute left-[35%] top-2 bottom-2 w-[15%] bg-accent/40 rounded" />
                <div className="absolute left-[55%] top-2 bottom-2 w-[25%] bg-accent/80 rounded" />
            ...
            <div className="bg-accent/5 border border-accent/20 rounded-lg p-4">
              <div className="flex items-centre gap-2 mb-3">
                ...
                <span className="text-sm font-bold">Mixing & Mastering</span>
              </div>
              <div className="relative h-12 bg-background/50 rounded overflow-hidden">
                <div className="absolute left-[65%] top-2 bottom-2 w-[30%] bg-accent/50 rounded" />
            ...
            <div className="bg-accent/5 border border-accent/20 rounded-lg p-4">
              <div className="flex items-centre gap-2 mb-3">
                ...
                <span className="text-sm font-bold">Visual Content</span>
              </div>
              <div className="relative h-12 bg-background/50 rounded overflow-hidden">
                <div className="absolute left-[25%] top-2 bottom-2 w-[35%] bg-accent/30 rounded" />
                <div className="absolute left-[70%] top-2 bottom-2 w-[20%] bg-accent/40 rounded" />
          ...
          <div className="bg-accent/5 border border-accent/20 rounded-lg p-4">
            <h3 className="text-sm font-bold mb-3">Project Inspector</h3>
            <div className="grid grid-cols-2 gap-4 text-xs">
              <div>
                <span className="text-foreground/60">Total Tracks:</span>
                <span className="ml-2 font-mono">12</span>
              </div>
              <div>
                <span className="text-foreground/60">Duration:</span>
                <span className="ml-2 font-mono">24:37</span>
              </div>
              <div>
                <span className="text-foreground/60">Collaborators:</span>
                <span className="ml-2 font-mono">3</span>
              </div>
              <div>
                <span className="text-foreground/60">Status:</span>
                <span className="ml-2 text-accent font-mono">In Progress</span>
              </div>
            </div>
          </div>
          ...
          <div className="absolute top-6 right-6 w-48 h-32 bg-background/80 border border-accent/20 rounded-lg p-2">
            <div className="text-[10px] text-foreground/60 mb-1">Timeline Overview</div>
            <div className="relative h-full bg-accent/5 rounded">
              {/* Mini timeline bars */}
              <div className="absolute left-[10%] top-[20%] w-[30%] h-1 bg-accent/40 rounded" />
              <div className="absolute left-[45%] top-[40%] w-[40%] h-1 bg-accent/40 rounded" />
              <div className="absolute left-[25%] top-[60%] w-[35%] h-1 bg-accent/40 rounded" />
