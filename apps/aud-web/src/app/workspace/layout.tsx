 ...
 *
 * ONBOARDING GATE: Redirects users who haven't completed onboarding to /onboarding.
 */
...
function OnboardingGate({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const checkAuthAndOnboarding = async () => {
      ...
      if (!user) {
        // Not authenticated - let them view workspace as guest
        // (some features will be gated)
